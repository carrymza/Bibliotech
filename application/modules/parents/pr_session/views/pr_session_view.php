...
<div class="container">
	<div class="img">
		<img src="<?php echo base_url();?>assets/template/session/img/family.svg">
	</div>
	<div class="login-content">
		<form id="login-form" action="<?php echo base_url();?>pr_session/auth" method="post">
			...
			<a href="<?php echo base_url();?>pr/recover">¿Olvido su contraseña?</a>
		</form>
	</div>
</div>
