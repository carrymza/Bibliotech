			...
			<div class="page-wrapper">
				<div class="page-header row">
					...
					<div class="col-md-4 text-right">
						<button type="button" class="btn btn-primary modal_trigger" data-target="#modals" data-toggle="modal" data-url="<?php echo base_url('loans/add');?>"><i class="ti-plus"></i>Nuevo</button>
					</div>
				</div>
				<div class="page-body">
					<div class="row">
