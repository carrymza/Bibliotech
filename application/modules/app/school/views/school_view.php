			...
			<div class="page-wrapper">
				<div class="page-header row">
					<div class="col-md-12 page-header-title">
						<h4>Informaci&oacute;n del Centro Educativo</h4>
						<div>
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="javascript:void(0);">Configuración</a></li>
								<li class="breadcrumb-item active"><a href="javascript:void(0);">Informaci&oacute;n del Centro Educativo</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="page-body">
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
								<div class="card-body">
									<form role="form" id="schools-form" method="post" action="<?php echo base_url('school/update/'.$this->schoolId);?>" class="form" enctype="multipart/form-data" onsubmit="return false;">
										...
										<div class="row">
											<div class="col-md-8 solid-black">
												<div class="main-information">
													...
													<div class="row form-group">
														<div class="col-md-3 text-right">
															<label for="slogan" class="label-style l-h-40">Eslogan:</label>
														</div>
														<div class="col-md-8 alpha">
												...
												<div class="contact-information">
													...
													<div class="row form-group">
														<div class="col-md-3 text-right">
															<label for="website" class="label-style l-h-40">Website:</label>
														</div>
														<div class="col-md-8 alpha">
