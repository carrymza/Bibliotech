<div class="modal-dialog modal-lg" id="employees" role="document">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="myModalLabel"><i class="icon-people p-r-7"></i>Agregar Empleado <span class="employee-title"></span></h5>
			<a href="javascript:void(0);" class="close" data-dismiss="modal" aria-hidden="true"><i class="icon-close"></i></a>
		</div>
		<div class="modal-body">
			<form role="form" id="employee-form" method="post" action="<?php echo base_url();?>employees/insert" class="form" enctype="multipart/form-data" onsubmit="return false;">
							...
							<div class="col-md-12 p-t-10">
								...
								<div class="row form-group">
									...
									<div class="col-md-5 alpha">
										<input type="text" class="form-control date" value="<?php echo date('Y-m-d');?>" name="birthday" id="birthday" readonly>
										<span class="valid-message"></span>
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-3 text-right">
										<label for="doc_typeId" class="label-style l-h-40">Posición:</label>
									</div>
									<div class="col-md-5 alpha">
										<?php echo form_dropdown('positionId', $this->positions, set_value('positionId', 0), "id='positionId' class='form-control select2'");?>
										<span class="valid-message"></span>
									</div>
									<div class="col-md-3 alpha another-position hidden">
								...
								<div class="row form-group">
									<div class="col-md-3 text-right">
										<label for="" class="label-style l-h-30">Activo:</label>
									</div>
									<div class="col-md-8 alpha">
										<input type="checkbox" name="statusId" id="statusId" value="1" class="checkbox-modal-1" checked/>
										<label for="statusId"> Empleado esta activo.</label>
									</div>
								</div>
							</div>
							<div class="col-md-12 p-t-10">
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-primary ladda-button" data-style="expand-left" id="employee-button"><span class="ladda-label">Guardar</span><span class="ladda-spinner"></span></button>
		</div>
	</div>
</div>
