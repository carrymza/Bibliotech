<div class="modal-dialog modal-lg" id="employees" role="document">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="myModalLabel"><i class="icon-people p-r-7"></i>Editar Empleado <span class="employee-title">/ <?php echo $row->first_name.' '.$row->last_name;?></span></h5>
			<a href="javascript:void(0);" class="close" data-dismiss="modal" aria-hidden="true"><i class="icon-close"></i></a>
		</div>
		<div class="modal-body">
			<form role="form" id="employee-form" method="post" action="<?php echo base_url('employees/update/'.$row->employeeId);?>" class="form" enctype="multipart/form-data" onsubmit="return false;">
							...
							<div class="col-md-12 p-t-10">
								<div class="col-md-12 header-section">
									...
									<div class="row form-group">
										...
										<div class="col-md-5 alpha">
											<?php echo form_dropdown('positionId', $this->positions, set_value('positionId', $row->positionId), "id='positionId' class='form-control select2'");?>
											<span class="valid-message"></span>
										</div>
										<div class="col-md-3 alpha omega another-position hidden">
											<input type="text" class="form-control" name="position_name" value="<?php echo $row->position_name;?>"  id="position_name">
											<span class="valid-message"></span>
										</div>
									</div>
									<div class="row form-group">
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-primary ladda-button" data-style="expand-left" id="employee-update-button"><span class="ladda-label">Guardar</span><span class="ladda-spinner"></span></button>
		</div>
	</div>
</div>
