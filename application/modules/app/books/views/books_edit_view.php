				...
				<div class="col-md-12 p-t-10">
					<div class="row form-group">
						...
						<div class="col-md-8 alpha">
							<input type="text" class="form-control" data-field="title" value="<?php echo $row->title;?>" name="title" id="title">
					...
					<div class="row form-group">
						...
						<div class="col-md-8 alpha">
							<input type="text" class="form-control" data-field="author" value="<?php echo $row->author;?>" name="author" id="author">
							<span class="valid-message"></span>
						</div>
					</div>
					<div class="row form-group">
						...
						<div class="col-md-7 alpha">
							<?php echo form_dropdown('editorialId', $this->editorials, set_value('editorialId', $row->editorialId), "id='editorialId' class='form-control select2'");?>
							<span class="valid-message"></span>
						</div>
					</div>
					<div class="row form-group">
						...
						<div class="col-md-8 alpha">
							<input type="text" class="form-control" data-field="edition" value="<?php echo $row->edition;?>" name="edition" id="edition">
							<span class="valid-message"></span>
						</div>
					</div>
					<div class="row form-group">
						...
						<div class="col-md-5 alpha">
							<input type="text" class="form-control date" value="<?php echo $row->publication_date;?>" name="publication_date" id="publication_date" readonly>
							<span class="valid-message"></span>
						</div>
					</div>
				</div>
	...
	$(document).ready(function () {
		...
		$(document).on("click", '#books-button', function(e) {
			...
			if (booksForm.errors() > 0) {
				...
				let data = {type: 'post', form: '#books-form', modal: '#modals', doAfter: 'datatable', selector: '#books', messageError: '.response', showAlert: true, titleResponse: "Exito!", textResponse: "Datos del Libro actualizados correctamente."};
				DOM.submitData(data);
			}
		});
	});
