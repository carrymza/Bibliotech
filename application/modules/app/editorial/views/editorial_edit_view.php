<div class="modal-dialog modal-lg" id="editorial" role="document">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="myModalLabel"><i class="icon-people p-r-7"></i>Editar Estudiante  <span class="editorial-title">/ <?php echo $row->first_name.' '.$row->last_name;?></span></h5>
	...
	$(document).ready(function () {
		...
		$(document).on("click", '#editorial-button', function(e) {
			...
			if (editorialForm.errors() > 0) {
				...
				var data = {type: 'post', form: '#editorial-form', modal: '#modals', doAfter: 'datatable', selector: '#editorial', messageError: '.response', showAlert: true, titleResponse: "Exito!", textResponse: "Datos del estudiante actualizados correctamente."};
				DOM.submitData(data);
			}
		});
	});
