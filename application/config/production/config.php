...
/*
|--------------------------------------------------------------------------
| HMVC Module location path
|--------------------------------------------------------------------------
|
| Path to the module folder for the HMVC implementation. This can be one
| or in can be multiple folders.
|
*/
...
|*/
$config['maintenance_mode'] = FALSE; // site is offline
