...
let loadDatatable = function () {
	let oTable = $('#returns').DataTable({
		"ajax":{
			url : URL.baseUrl()+'returns/datatable'
		},
		"columns" : [
			{ "data" : "returnId", 	"sClass": "dt-returnId",   		"width": "0%",  	"defaultContent": "<span class='text-muted'>N/A</span>"},
...
let options = function (data) {
	...
	html += '<div class="dropdown-primary dropdown open">\n' +
		...
		'<a class="dropdown-item modal_trigger" data-target="#modals" data-toggle="modal" href="javascript:void(0);" data-url="'+URL.baseUrl()+'returns/edit/'+id+'"><i class="ti-pencil-alt"></i> Editar</a>\n'+
		'<a class="dropdown-item delete_dt_item" data-table="#returns" data-url="'+URL.baseUrl()+'returns/delete/'+id+'" href="javascript:void(0);"><i class="ti-trash"></i> Eliminar</a>\n';
	html +='</div></div>';
